...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'day1.data';
    var REMOTE_PACKAGE_BASE = 'day1.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_day1.data');

    };
    Module['addRunDependency']('datafile_day1.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 3406, "filename": "/data.txt"}], "remote_package_size": 3406, "package_uuid": "fd030377-4267-4bf3-87c2-ceef8d6f655b"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'day1.wast';
  var wasmBinaryFile = 'day1.wasm';
  var asmjsCodeFile = 'day1.temp.asm.js';
