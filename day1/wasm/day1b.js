...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'day1b.data';
    var REMOTE_PACKAGE_BASE = 'day1b.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_day1b.data');

    };
    Module['addRunDependency']('datafile_day1b.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 3406, "filename": "/data.txt"}], "remote_package_size": 3406, "package_uuid": "3fef0e1b-8aa9-4cbd-b38a-e60a2b116662"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'day1b.wast';
  var wasmBinaryFile = 'day1b.wasm';
  var asmjsCodeFile = 'day1b.temp.asm.js';
